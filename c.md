...
- [C++编程基础](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.1)<a name="context.1"> </a>
  ...
  - [指针](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.21)<a name="context.21"> </a>
    - [野指针](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.22)<a name="context.22"> </a>
  ...
  - [宏](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.54)<a name="context.54"> </a>
...
- [类 & 对象](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.72)<a name="context.72"> </a>
  ...
  - [= default和=  delete](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.85)<a name="context.85"> </a>
    - [不建议重载的运算符](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.86)<a name="context.86"> </a>
  ...
  - [存储类](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.118)<a name="context.118"> </a>
...
- [智能指针](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.145)<a name="context.145"> </a>
  ...
  - [shared_ptr是否线程安全](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.150)<a name="context.150"> </a>
...
- [\__attribute__](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.170)<a name="context.170"> </a>
  - [\__attribute__((unused))](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.171)<a name="context.171"> </a>
  - [\__attribute__ ((__packed__))](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.172)<a name="context.172"> </a>
  - [\__**attribute**__((aligned(n)))](https://github.com/jinbooooom/programming-summary/blob/master/C-plus-plus/C-plus-plus.md#section.173)<a name="context.173"> </a>
------------------------------------------------  
## [C++编程基础](#context.1)<a name="section.1"> </a>

### [Hello, world!](#context.2)<a name="section.2"> </a>
...
#### [main 函数前面的数据类型 int 与 void](#context.3)<a name="section.3"> </a>
...
#### [main 函数执行完后执行其他语句](#context.4)<a name="section.4"> </a>
...
#### [main函数之前执行的操作](#context.5)<a name="section.5"> </a>
...
#### ["\n" 与 endl 的区别](#context.6)<a name="section.6"> </a>
...
#### [头文件里的 " " 与](#context.7)<a name="section.7"> </a>
...
#### [命名空间 std](#context.8)<a name="section.8"> </a>
...
#### [system("pause")](#context.9)<a name="section.9"> </a>

包含头文件 stdlib.h，并在主程序中加入 `system("pause");` 可以在程序运行完以后使黑框暂停显示，等待输入，而不是闪退。linux环境下运行该程序需去掉该语句。

#### [cout 与 printf()](#context.10)<a name="section.10"> </a>
...
#### [main函数与命令行参数](#context.11)<a name="section.11"> </a>
...
#### [预处理、编译与链接](#context.12)<a name="section.12"> </a>
...
##### [静态链接和动态链接](#context.13)<a name="section.13"> </a>
...
##### [动态库里分配的内存在主程序中不可以释放](#context.14)<a name="section.14"> </a>
...
### [iostream](#context.15)<a name="section.15"> </a>
...
### [变量](#context.16)<a name="section.16"> </a>

#### [勿混用带符号类型和无符号类型](#context.17)<a name="section.17"> </a>
...
#### [无符号数不会小于0这一事实关系到循环的写法](#context.18)<a name="section.18"> </a>
...
### [初始化](#context.19)<a name="section.19"> </a>
...
### [逗号表达式](#context.20)<a name="section.20"> </a>
...
### [指针](#context.21)<a name="section.21"> </a>
...
#### [野指针](#context.22)<a name="section.22"> </a>
...
#### [悬空指针](#context.23)<a name="section.23"> </a>
...
#### [指针与数组名的区别](#context.24)<a name="section.24"> </a>
...
#### [数组指针与指针数组](#context.25)<a name="section.25"> </a>
...
#### [指针函数与函数指针](#context.26)<a name="section.26"> </a>
...
#### [复杂指针声明](#context.27)<a name="section.27"> </a>
...
### [指针(pointer)与引用(reference)](#context.28)<a name="section.28"> </a>
...
#### [引用作为函数参数](#context.29)<a name="section.29"> </a>
...
#### [常引用作为函数参数](#context.30)<a name="section.30"> </a>
...
#### [函数返回引用与返回值](#context.31)<a name="section.31"> </a>
...
### [指针运算](#context.32)<a name="section.32"> </a>

#### [\*&p和&\*p](#context.33)<a name="section.33"> </a>
...
#### [p+(或-)n](#context.34)<a name="section.34"> </a>
...
#### [\*p++，*(p++)， (\*p)++，\*++p，++\*p](#context.35)<a name="section.35"> </a>
...
### [i++ 与 ++i 的效率](#context.36)<a name="section.36"> </a>
...
### [sizeof](#context.37)<a name="section.37"> </a>

#### [sizeof 计算普通变量与指针所占空间的大小](#context.38)<a name="section.38"> </a>
...
#### [sizeof 计算空类的大小](#context.39)<a name="section.39"> </a>
...
#### [sizeof 计算类对象与结构体、联合体所占空间的大小](#context.40)<a name="section.40"> </a>
...
#### [sizeof 与 strlen 区别](#context.41)<a name="section.41"> </a>
...
### [strcpy 与 memcpy 区别](#context.42)<a name="section.42"> </a>
...
### [作用域与生存周期](#context.43)<a name="section.43"> </a>

c++ 变量有两个属性非常重要：作用域和生存周期。

#### [花括号作用域](#context.44)<a name="section.44"> </a>
...
#### [内存分配](#context.45)<a name="section.45"> </a>
...
#### [局部变量和全局变量](#context.46)<a name="section.46"> </a>
...
##### [操作系统和编译器是怎么知道变量是全局还是局部？](#context.47)<a name="section.47"> </a>

操作系统和编译器，可能是通过内存分配的位置来知道的，全局变量分配在全局数据段并且在程序开始运行的时候被加载。局部变量则分配在堆栈里面。

#### [静态存储与动态存储](#context.48)<a name="section.48"> </a>
...
#### [C++变量保存在堆还是栈？](#context.49)<a name="section.49"> </a>
...
#### [堆与栈的效率](#context.50)<a name="section.50"> </a>
...
### [new 与 delete](#context.51)<a name="section.51"> </a>
...
#### [new/delete 与 malloc/free 关系](#context.52)<a name="section.52"> </a>
...
#### [malloc、calloc、realloc的区别](#context.53)<a name="section.53"> </a>
...
### [宏](#context.54)<a name="section.54"> </a>
...
// 为什么用括号？因为宏只是简单的字符替换
```
### [头文件](#context.55)<a name="section.55"> </a>
...
#### [#ifndef/#define/#endif作用](#context.56)<a name="section.56"> </a>
...
#### [extern “C”](#context.57)<a name="section.57"> </a>
...
### [typedef 声明](#context.58)<a name="section.58"> </a>
...
### [decltype 类型指示符](#context.59)<a name="section.59"> </a>
...
### [枚举类型](#context.60)<a name="section.60"> </a>
...
### [C结构体、C++结构体、C++类的区别](#context.61)<a name="section.61"> </a>
...
#### [结构体与联合体（共用体）的区别](#context.62)<a name="section.62"> </a>
...
### [类型转换](#context.63)<a name="section.63"> </a>

【PRIMER 142-146】

无须程序员介入，会自动执行的类型转换叫做隐式转换（implicit conversions）。

#### [算术转换](#context.64)<a name="section.64"> </a>
...
#### [其他隐式类型转换](#context.65)<a name="section.65"> </a>
...
#### [显式转换](#context.66)<a name="section.66"> </a>
...
#### [类型安全](#context.67)<a name="section.67"> </a>
...
### [try语句块和异常处理](#context.68)<a name="section.68"> </a>
...
#### [throw表达式](#context.69)<a name="section.69"> </a>

`throw`表达式包含关键字`throw`和紧随其后的一个表达式，其中表达式的类型就是抛出的异常类型。

#### [try语句块](#context.70)<a name="section.70"> </a>
...
#### [标准异常](#context.71)<a name="section.71"> </a>
...
## [类 & 对象](#context.72)<a name="section.72"> </a>
...
### [类对象声明](#context.73)<a name="section.73"> </a>
...
### [类访问修饰符](#context.74)<a name="section.74"> </a>
...
### [封装继承多态](#context.75)<a name="section.75"> </a>

#### [**封装**](#context.76)<a name="section.76"> </a>

封装是实现面向对象程序设计的第一步，封装就是将数据或函数等集合在一个个的单元中（称之为类）。

封装的意义在于保护或者防止代码（数据）被无意中破坏。

#### [**继承**](#context.77)<a name="section.77"> </a>
...
##### [私有继承的作用](#context.78)<a name="section.78"> </a>
...
##### [私有继承与组合的不同](#context.79)<a name="section.79"> </a>
...
#### [**多态**](#context.80)<a name="section.80"> </a>
...
#### [**重载与重写**](#context.81)<a name="section.81"> </a>
...
### [构造函数与析构函数](#context.82)<a name="section.82"> </a>
...
#### [构造函数不能声明为const](#context.83)<a name="section.83"> </a>
...
### [委托构造函数](#context.84)<a name="section.84"> </a>

C++11扩展了构造函数初始值功能，可以定义委托构造函数。委托构造函数使用它所属类的其他构造函数执行它自己的初始化过程。【PRIMER 261】

### [= default和=  delete](#context.85)<a name="section.85"> </a>
...
#### [不建议重载的运算符](#context.86)<a name="section.86"> </a>
...
#### [= default 显示缺省函数](#context.87)<a name="section.87"> </a>
...
#### [= delete 显示删除函数](#context.88)<a name="section.88"> </a>
...
### [拷贝（复制）构造函数](#context.89)<a name="section.89"> </a>
...
#### [什么情况使用拷贝构造函数](#context.90)<a name="section.90"> </a>
...
#### [浅复制与深复制](#context.91)<a name="section.91"> </a>
...
### [临时对象的复制与析构](#context.95)<a name="section.95"> </a>
...
### [空类的成员函数](#context.96)<a name="section.96"> </a>
...
### [初始化列表](#context.97)<a name="section.97"> </a>

#### [使用初始化列表的原因](#context.98)<a name="section.98"> </a>
...
#### [必须使用初始化列表的情况](#context.99)<a name="section.99"> </a>
...
#### [初始化顺序](#context.100)<a name="section.100"> </a>
...
### [友元](#context.101)<a name="section.101"> </a>

#### [友元函数](#context.102)<a name="section.102"> </a>
...
#### [友元类](#context.103)<a name="section.103"> </a>
...
#### [友元访问控制与继承](#context.104)<a name="section.104"> </a>
...
### [内联函数](#context.105)<a name="section.105"> </a>
...
#### [内联函数与宏的区别](#context.106)<a name="section.106"> </a>
...
### [volatile](#context.107)<a name="section.107"> </a>
...
#### [一个参数可以既是 const 又是 volatile 吗](#context.108)<a name="section.108"> </a>
...
### [explicit](#context.109)<a name="section.109"> </a>
...
### [const](#context.110)<a name="section.110"> </a>
...
#### [const形参和实参](#context.111)<a name="section.111"> </a>
...
#### [函数返回引用](#context.112)<a name="section.112"> </a>
...
#### [const作用](#context.113)<a name="section.113"> </a>
...
#### [const修饰指针](#context.114)<a name="section.114"> </a>
...
#### [constexpr和常量表达式](#context.115)<a name="section.115"> </a>
...
#### [const 与 #define](#context.116)<a name="section.116"> </a>
...
### [mutable](#context.117)<a name="section.117"> </a>
...
### [存储类](#context.118)<a name="section.118"> </a>

#### [auto](#context.119)<a name="section.119"> </a>
...
#### [static作用](#context.120)<a name="section.120"> </a>
...
##### [静态数据成员与全局变量相比的优势](#context.121)<a name="section.121"> </a>

- 静态数据成员没有进入程序的全局命名空间，因此不存在与其他全局变量名字冲突的可能；
- 使用静态数据成员可以隐藏信息。因为静态数据成员可以是 private 成员，而全局变量不能；

#### [extern](#context.122)<a name="section.122"> </a>
...
### [类型转换运算符](#context.123)<a name="section.123"> </a>
...
#### [为什么不使用 C 的强制转换](#context.124)<a name="section.124"> </a>

  C 的强制转换表面上看起来功能强大什么都能转，但是转化不够明确，不能进行错误检查，容易出错。 

### [this指针](#context.125)<a name="section.125"> </a>
...
### [虚函数](#context.126)<a name="section.126"> </a>
...
#### [回避虚函数](#context.127)<a name="section.127"> </a>
...
#### [虚函数原理](#context.128)<a name="section.128"> </a>
...
#### [虚函数是否可以内联](#context.129)<a name="section.129"> </a>
...
#### [虚析构函数](#context.130)<a name="section.130"> </a>
...
#### [静态联编和动态联编](#context.131)<a name="section.131"> </a>
...
#### [在构造函数和析构函数内调用虚函数](#context.132)<a name="section.132"> </a>
...
#### [有关虚函数的注意事项](#context.133)<a name="section.133"> </a>
...
#### [纯虚函数](#context.134)<a name="section.134"> </a>
...
#### [虚函数、纯虚函数](#context.135)<a name="section.135"> </a>
...
#### [抽象类与虚基类](#context.136)<a name="section.136"> </a>
...
### [继承](#context.137)<a name="section.137"> </a>
...
#### [访问控制](#context.138)<a name="section.138"> </a>
...
#### [改变成员的可访问性](#context.139)<a name="section.139"> </a>
...
#### [不存在从基类向派生类的隐式转换](#context.140)<a name="section.140"> </a>
...
#### [多重继承与虚继承以及消除二义性方法](#context.141)<a name="section.141"> </a>
...
#### [多继承中构造函数的调用顺序](#context.142)<a name="section.142"> </a>
...
### [右值引用](#context.143)<a name="section.143"> </a>
...
#### [左值与右值](#context.144)<a name="section.144"> </a>
...
## [智能指针](#context.145)<a name="section.145"> </a>
...
### [智能指针的内存泄露以及解决方法](#context.146)<a name="section.146"> </a>
...
### [为什么摒弃 auto_ptr](#context.147)<a name="section.147"> </a>
...
### [更多用法（C++ 11）](#context.148)<a name="section.148"> </a>
...
### [智能指针与普通指针的转换](#context.149)<a name="section.149"> </a>
...
### [shared_ptr是否线程安全](#context.150)<a name="section.150"> </a>
...
### [unique_ptr](#context.151)<a name="section.151"> </a>
...
### [weak_ptr](#context.152)<a name="section.152"> </a>
...
#### [使用weak_ptr防止循环引用](#context.153)<a name="section.153"> </a>
...
## [基于范围的 for 循环](#context.154)<a name="section.154"> </a>
...
### [处理多维数组](#context.155)<a name="section.155"> </a>
...
## [lambda 表达式](#context.156)<a name="section.156"> </a>
...
### [lambda捕获变量和返回](#context.157)<a name="section.157"> </a>
...
### [参数绑定](#context.158)<a name="section.158"> </a>
...
## [函数调用运算符](#context.159)<a name="section.159"> </a>

### [重载operator()运算符](#context.160)<a name="section.160"> </a>
...
### [lambda是函数对象](#context.161)<a name="section.161"> </a>
...
### [可调用对象与function](#context.162)<a name="section.162"> </a>
...
# [C++14 新特性](#context.163)<a name="section.163"> </a>

## [函数返回值可以使用`auto`推导](#context.164)<a name="section.164"> </a>
...
## [std::make_unique](#context.165)<a name="section.165"> </a>
...
## [std::shared_timed_mutex与std::shared_lock](#context.166)<a name="section.166"> </a>
...
# [杂项](#context.167)<a name="section.167"> </a>

## [std::this_thread::sleep_for和直接使用sleep有什么区别](#context.168)<a name="section.168"> </a>

C函数sleep(),usleep()和Sleep()是平台特定的而不是C++标准库的一部分。

而this_thread::sleep_for是平台无关的，在windows和linux上都可以这么写，具体链接的函数交给STL负责就是。

## [likely和unlikely](#context.169)<a name="section.169"> </a>
...
## [\__attribute__](#context.170)<a name="section.170"> </a>

更多可以参考[\__attribute__ 机制详解](https://blog.csdn.net/weaiken/article/details/88085360)，下面列举一些遇到的

### [\__attribute__((unused))](#context.171)<a name="section.171"> </a>
...
### [\__attribute__ ((__packed__))](#context.172)<a name="section.172"> </a>
...
### [\__**attribute**__((aligned(n)))](#context.173)<a name="section.173"> </a>
